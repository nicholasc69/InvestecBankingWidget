...
expect fun getDatabaseBuilder(context: Any? = null): RoomDatabase.Builder<BankDatabase>

fun createDatabase(builder: RoomDatabase.Builder<BankDatabase>): BankDatabase {
    return builder
